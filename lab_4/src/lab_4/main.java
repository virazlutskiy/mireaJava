...
P.S. для простоты реализации и наглядности демонстрации был использован код лабораторной №3
 */

public class main {

	public static void main(String[] args) {
		Nameable plate = new Plate("Тарелка",100,"Белая",20,3);
		Nameable cup = new Cup("Чашка",250,"Черная",200);
